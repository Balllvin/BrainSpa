# Training Methods (Open-Source References)

Moved to a chunked set of docs. Start here:
...
| [training-method-catalog.md](training-method-catalog.md) | Full method + repo tables |
